...
bool ebug_base__msg__control_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ebug_base.msg._control_command.ControlCommand", full_classname_dest, 45) == 0);
  }
  ebug_base__msg__ControlCommand * ros_message = _ros_message;
  {  // control
...
PyObject * ebug_base__msg__control_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ebug_base.msg._control_command");
