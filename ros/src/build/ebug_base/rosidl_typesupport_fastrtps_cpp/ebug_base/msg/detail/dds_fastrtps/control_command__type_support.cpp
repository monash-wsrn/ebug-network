...
#include "ebug_base/msg/detail/control_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ebug_base::msg::ControlCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ebug_base::msg::ControlCommand & ros_message)
{
  // Member: control
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ebug_base::msg::ControlCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ebug_base::msg::ControlCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ebug_base::msg::ControlCommand *>(
    untyped_ros_message);
...
{
  return &ebug_base::msg::typesupport_fastrtps_cpp::_ControlCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ebug_base, msg, ControlCommand)() {
  return &ebug_base::msg::typesupport_fastrtps_cpp::_ControlCommand__handle;
}
