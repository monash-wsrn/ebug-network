...
#include "ebug_base/msg/detail/robot_pose__rosidl_typesupport_fastrtps_c.h"
...
using _RobotPose__ros_msg_type = ebug_base__msg__RobotPose;
...
size_t get_serialized_size_ebug_base__msg__RobotPose(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RobotPose__ros_msg_type * ros_message = static_cast<const _RobotPose__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RobotPose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ebug_base__msg__RobotPose(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ebug_base
size_t max_serialized_size_ebug_base__msg__RobotPose(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ebug_base__msg__RobotPose;
    is_plain =
      (
...
static size_t _RobotPose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ebug_base__msg__RobotPose(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ebug_base, msg, RobotPose)() {
