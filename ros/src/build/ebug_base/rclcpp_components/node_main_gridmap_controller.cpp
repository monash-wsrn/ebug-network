...
#define NODE_MAIN_LOGGER_NAME "gridmap_controller"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libgridmap_controller_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ebug::GridmapController>";
