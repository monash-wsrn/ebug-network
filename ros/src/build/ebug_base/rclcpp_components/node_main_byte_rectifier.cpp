...
#define NODE_MAIN_LOGGER_NAME "byte_rectifier"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libbyte_rectifier_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ebug::ByteRectifier>";
