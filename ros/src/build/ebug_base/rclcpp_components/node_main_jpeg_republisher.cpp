...
#define NODE_MAIN_LOGGER_NAME "jpeg_republisher"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libjpeg_republisher_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ebug::JpegRepublisher>";
