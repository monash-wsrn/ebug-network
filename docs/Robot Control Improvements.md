...
4. [Gyroscope Sensor Fusion](#Gyroscope-Sensor-Fusion)
5. [AprilTag Improvements](#AprilTag-Improvements)
...
- **Gyroscope-encoder sensor fusion**: Integrated gyroscope for better orientation tracking.
